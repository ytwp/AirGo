...
currentVersion=''
latestVersion=''
downloadPrefix='https://github.com/ytwp/AirGo/releases/download/'
githubApi="https://api.github.com/repos/ytwp/AirGo/releases/latest"
manageScript="https://raw.githubusercontent.com/ytwp/AirGo/main/server/scripts/install.sh"
